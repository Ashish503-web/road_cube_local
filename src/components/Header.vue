            ...
            >
                ...
                <v-col cols="auto" :hidden="$vuetify.breakpoint.smAndDown">
                    <v-toolbar-items class="d-flex align-center justify-center">
                        <v-btn text href="#home" class="light-theme active"
                            >home</v-btn
                        >
                        <v-btn text href="#products" class="light-theme"
                            >why roadcube</v-btn
                        >
                        <v-btn text href="#about" class="light-theme"
                            >about</v-btn
                        >
                        <v-btn text href="#features" class="light-theme"
                            >features</v-btn
                        >
                        <v-btn text href="#quote" class="light-theme"
                            >quote</v-btn
                        >
                        <v-btn text href="#cta" class="light-theme"
                            >contact</v-btn
                        >
                        <v-btn
