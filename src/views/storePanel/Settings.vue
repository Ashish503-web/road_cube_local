    ...
    <v-container fluid class="b-container">
        <v-sheet class="pa-3">
            <v-row no-gutters>
                ...
                <v-col cols="12">
                    <v-card tile flat class="py-5 px-12">
                        <v-tabs-items v-model="tab">
                                    ...
                                    <v-card-text class="pb-0 pt-8">
                                        ...
                                        <v-row>
                                            ...
                                            >
                                                <v-card
                                                    width="300"
                                                    class="subtitle-2 py-3 px-5 relative"
                                                >
                                                    <v-badge
                                                    ...
                                                    <v-sheet
                                                        color="red"
                                                        width="20"
                                                        class="rounded-circle text-center category-remove"
                                                        dark
                                                        @click="
                                                            removeCategory(i)
                                                        "
                                ...
                                <v-row no-gutters>
                                    <v-col cols="9">
                                        ...
                                        <v-card-text>
                                            ...
                                            <h4 class="subtitle-2 pl-9">
                                                How to notify a consumer of
                                                points
                                            </h4>
                                            <v-container>
                                                <v-row>
                            ...
                            <v-tab-item>
                                <v-card tile flat>
                                    <v-card-text>
                                        Set up one or more mobile payments for
                                        your business.
