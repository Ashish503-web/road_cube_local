        ...
        >
            <v-row>
                <v-col cols="6" class="pl-8">
                    ...
                    <img
                        src="https://www.roadcube.com/images/no_image_icon.png"
                        alt=""
                    />
                    <div class="my-2">
...
<script>
import ChooseFile from "../../BusinessProfile/components/ChooseFile";

export default {
    props: ["formModal"],
    methods: {
        checkHandler() {
            this.formModal.productImageCheck.active = !this.formModal
                .productImageCheck.active;
        }
    },
    components: {
