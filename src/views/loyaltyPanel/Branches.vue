                ...
                <v-col cols="12" sm="auto">
                  ...
                  >
                    ...
                    <v-card class="pb-5">
                      ...
                      <v-card-text>
                        <v-form class="pt-5">
                          <label class="font-weight-bold ml-5">Select Package</label>
                          <v-select
                              ...
                              rounded
                          ></v-select>
                          <label class="font-weight-bold ml-5">Please choose category where gifts of company will show</label>
                          <v-select
                              ...
                              rounded
                          ></v-select>
                          <label class="font-weight-bold ml-5">Name of Shop</label>
                          <v-text-field
                              placeholder="Name"
                              required
                              outlined
                              ...
                              class="mt-1 mb-0"
                          ></v-text-field>
                          <label class="font-weight-bold ml-5">Name of Shop(in app)</label>
                          <v-text-field
                              placeholder="Name"
                              required
                              outlined
                              ...
                              class="mt-1 mb-0"
                          ></v-text-field>
                          <label class="font-weight-bold ml-5">Select Region</label>
                          <v-select
                              v-model="region"
                              :items="regions"
                              :value="region"
                          ...
                          <v-card tile flat style="position: relative; bottom: 20px">
                            <v-card-title>
                              <v-btn
                                  text
                                  @click="addRegionDialog = !addRegionDialog"
                            ...
                            >
                              ...
                              <v-icon
                                ...
                                size="60"
                                class="ml-10"
                                @click="addRegionDialog = false; writtenRegion = false; regions.push(new_region); new_region = ''"
                              >
                              </v-icon>
                            </v-card-text>
                          </v-card>
                          <label class="font-weight-bold d-block ml-5">Password of Shop</label>
                          <v-text-field
                              placeholder="Code"
                              required
                              outlined
                              ...
                              class="mt-1 mb-0"
                          ></v-text-field>
                          <label class="font-weight-bold ml-5">Email of Shop(in app)</label>
                          <v-text-field
                              placeholder="Email"
                              required
                              outlined
                              ...
                              class="mt-1 mb-0"
                          ></v-text-field>
                          <label class="font-weight-bold ml-5">Address of Shop</label>
                          <v-text-field
                              placeholder="Address"
                              required
                              outlined
                          ...
                          <v-text-field
                              ...
                              class="mt-1 mb-0"
                          ></v-text-field>
                          <label class="font-weight-bold ml-5">Number of Shop</label>
                          <v-text-field
                              placeholder="Number"
                              required
                              outlined
                ...
                <v-col cols="12" sm="auto" class="ml-sm-auto pb-0">
                  ...
                  >
                    ...
                    <v-card class="pb-5">
                      ...
                      <v-card-text>
                        <h4 class="subtitle-2 font-weight-bold mt-10">Select Companies which you want to be able to Add / Delete</h4>
                  ...
                  >
                            ...
                            <v-card tile flat style="position: relative; bottom: 20px">
                              ...
                              >
                                ...
                                <v-icon
                                    ...
                                    size="60"
                                    class="ml-10"
                                    @click="addRegionDialog = false; writtenRegion = false; regions.push(new_region2); new_region2 = ''"
                                >
                                </v-icon>
                              </v-card-text>
                            </v-card>
                    ...
                    >
                      ...
                      <v-card>
                        ...
                        <v-card-text>
                          <h4 class="subtitle-2 font-weight-medium mt-5">Want to go to your substitute on the road {{ }}.</h4>
                          <h4 class="subtitle-2 font-weight-medium mt-5 mb-5">Do you want to continue?</h4>
                        </v-card-text>
                    ...
                    >
                      ...
                      <v-card class="pb-5">
                        ...
                        <v-card-text>
                          <h4 class="subtitle-2 font-weight-medium mt-5">Are you sure you want to delete {{ }}.</h4>
                          <h4 class="subtitle-2 font-weight-medium mt-5 mb-4">Do you want to continue?</h4>
                          <v-checkbox class="d-inline-block ma-0"></v-checkbox>
                          <h4 class="subtitle-2 font-weight-medium d-inline-block" style="position: relative; bottom: 7px">Do you want to totally delete Company?</h4>
                        </v-card-text>
                ...
                >
                  ...
                  >
                    <v-text-field
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Name</h4>
                  </template>
                  <template
                    v-slot:header.name_of_shop
                  >
                    <v-text-field
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Name of Shop(i app)</h4>
                  </template>
                  <template
                    v-slot:header.customer
                  >
                    <v-text-field
                        label="Search"
                        outlined
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Customer</h4>
                  </template>
                  <template
                    v-slot:header.transaction
                  >
                    <v-text-field
                        label="Search"
                        outlined
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Transaction</h4>
                  </template>
                  <template
                    v-slot:header.total
                  >
                    <v-text-field
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Total</h4>
                  </template>
                  <template
                    v-slot:header.points
                  >
                    <v-text-field
                        label="Search"
                        outlined
                        ...
                        class="mt-2 mb-2"
                    ></v-text-field>
                    <h4 class="subtitle-2 mb-2 font-weight-bold d-inline-block">Points</h4>
                  </template>
                </v-data-table>
              </v-card>
            </v-tab-item>
            <v-tab-item>
              <v-card flat class="pa-5">
                ...
                >
                  ...
                  <template
                      v-slot:header.open_settings
                  >
                    <h4 class="caption font-weight-bold">Open Settings</h4>
                    <h4 class="caption font-weight-bold d-inline-block mt-4">Update All </h4>
                    <v-checkbox class="ma-0"></v-checkbox>
                  </template>
                  <template
                      v-slot:header.open_actions
                  >
                    <h4 class="caption font-weight-bold">Open Promotional Actions</h4>
                    <h4 class="caption font-weight-bold d-inline-block">Update All </h4>
                    <v-checkbox class="d-inline-block ma-0" style="position: relative; top: 7px"></v-checkbox>
                  </template>
                  <template
                  ...
                  <template
                      v-slot:header.body_pricing_file
                  >
                  ...
                  <template
                      v-slot:header.open_selection
                  >
                    <h4 class="caption font-weight-bold">Open Redeem Mode Selection</h4>
                    <h4 class="caption font-weight-bold d-inline-block">Update All </h4>
                    <v-checkbox class="d-inline-block ma-0" style="position: relative; top: 7px"></v-checkbox>
                  </template>
                  <template
                      v-slot:header.open_product
                  >
                    <h4 class="caption font-weight-bold">Open Product Insertion / Modification</h4>
                    <h4 class="caption font-weight-bold d-inline-block">Update All </h4>
                    <v-checkbox class="d-inline-block ma-0" style="position: relative; top: 7px"></v-checkbox>
                  </template>
                  <template
                      v-slot:header.open_discount
                  >
                  ...
                  <template
                      v-slot:item.open_settings
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_actions
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                  ...
                  <template
                      v-slot:item.body_pricing_file
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_add_coupon
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_selection
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_product
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_discount
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                </v-data-table>
            ...
            <v-tab-item>
              <v-card flat class="pa-5">
                ...
                >
                  ...
                  <template
                      v-slot:item.open_shop
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_checkin
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                  <template
                      v-slot:item.open_scanning
                  >
                    <v-checkbox></v-checkbox>
                  </template>
                </v-data-table>
                    ...
                    <v-card class="pb-5">
                      <v-card-title class="primary--text font-weight-medium pa-2 pl-4 pr-0">
                        ...
                        <v-btn
                            ...
                            icon
                            rounded
                            @click="generalLimitsDialog = false"
                            class="ml-auto mr-2 title text-lowercase"
                            style="transform: rotate(45deg)"
                        >
                          +
                      ...
                      <v-card-text class="mt-5 pb-0">
                        <v-row>
                          ...
                          <v-col cols="3" class="pl-2 pr-2 mt-2">
                            <h4 class="subtitle-2 font-weight-medium">Daily Transaction Limits</h4>
                          </v-col>
                          <v-col cols="3" class="pl-2 pr-2">
                            <v-text-field
                                outlined
                      ...
                      <v-card color="#f9f9f9" class="pa-5 ma-5 mb-0 mt-0" flat tile align="end">
                        <v-btn
                            color="#dbe1e8"
                            @click="generalLimitsDialog = false"
                            class="mr-2 text-capitalize"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <v-card class="pb-5">
                        <v-card-title class="primary--text font-weight-medium pa-2 pl-4 pr-0">
                          Change Transaction Limits for company {{  }}
                          <v-btn
                              color="grey"
                              icon
...
<script>
import { mdiTools, mdiMagnify, mdiSquareEditOutline, mdiNavigation, mdiBackspace, mdiPlusThick,
...
export default {
    ...
    data: () => ({
      ...
      gift_categories: ['Auto - Moto', 'Entertainment', 'Sports, Fitness', 'Travel, Leisure', 'Food, Drink', 'For the House', 'Clothing, Footwear, Accessories', 'Health, Care, Beauty', 'Department Stores', 'Others', 'Technology'],
      gift_category: 'Auto - Moto',
      regions: ['No Region', 'asdasdas', 'ewfweaaf', 'sdsdasd', 'asdasd', 'qwsds', 'bnmvm', 'ukyukyuk', 'wdqcdzvbngn', 'ascafdf', 'ipoljm', 'vcnmvnmnsgrg'],
      region: 'No Region',
      ...
      branchesHeaders: [
        ...
        { text: 'Name of Shop(in app)', value: 'name_of_shop', align: 'center' },
        ...
        { text: 'Registration Date', value: 'registration_date', align: 'center' },
      ...
      adminSetHeaders: [
        ...
        { text: 'Open Promotional Actions', value: 'open_actions', sortable: false },
        { text: 'Manual Points Delivery', value: 'manual_points_delivery', sortable: false },
        { text: 'Body pricing file', value: 'body_pricing_file', sortable: false },
        { text: 'Open Add Coupon', value: 'open_add_coupon', sortable: false },
        { text: 'Open Redeem Mode Selection', value: 'open_selection', sortable: false },
        { text: 'Open Product Insertion / Modification', value: 'open_product' },
      ...
      appSetHeaders: [
        ...
        { text: 'Open Receipt Scanning', value: 'open_scanning', sortable: false },
      ],
      appSetData: [
        {
          name: 'Vasilisa'
      ...
      limitsHeaders: [
        { text: 'Name', value: 'name', align: 'center' },
        { text: 'Offline Transaction Limits', value: 'offline_limits', align: 'center' },
      ],
      limitsData: [
        {
          name: 'Vasilis'
