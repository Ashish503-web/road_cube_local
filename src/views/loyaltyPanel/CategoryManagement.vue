    ...
    <v-container fluid class="b-container">
        <v-sheet class="pa-3">
            ...
            <v-dialog v-model="dialog" max-width="40%" scrollable>
                <CreateUpdateCategory @close="dialog=false"/>
            </v-dialog>
        </v-sheet>
    </v-container>
</template>
...
<script>
    ...
    import CreateUpdateCategory from "../../components/loyaltyPanel/CreateUpdateCategory/CreateUpdateCategory";


    export default {
        name: "CategoryManagement",
        components: { CreateUpdateCategory },
        data: () => ({
            icons: {
                mdiPencilOutline,
                mdiClose,
