        ...
        <v-hover v-slot:default="{ hover }">
          <v-card tile class="pa-5" outlined :elevation="hover ? 3 : 0">
            <v-row no-gutters justify="space-between" align="center">
              ...
              <v-col cols="auto">
                <v-card-title class="subtitle-1 font-weight-bold pa-0 justify-end">197</v-card-title>
        ...
        <v-hover v-slot:default="{ hover }">
          <v-card tile class="pa-5" outlined :elevation="hover ? 3 : 0">
            <v-row no-gutters justify="space-between" align="center">
              ...
              <v-col cols="auto">
                <v-card-title class="subtitle-1 font-weight-bold pa-0 justify-end">42</v-card-title>
                <h4 class="subtitle-2 font-weight-regular text--secondary">User leads</h4>
              </v-col>
            </v-row>
          </v-card>
        </v-hover>
        ...
        <v-hover v-slot:default="{ hover }">
          <v-card tile class="pa-5" outlined :elevation="hover ? 3 : 0">
            <v-row no-gutters justify="space-between" align="center">
              ...
              <v-col cols="auto">
                <v-card-title class="subtitle-1 font-weight-bold pa-0 justify-end">32</v-card-title>
            ...
            <v-row no-gutters justify="space-between" align="center">
              <v-col cols="auto">
                <v-sheet color="accent" dark class="rounded-circle">
                  <v-icon class="ma-3" large v-text="icons.mdiWallet" style="transform: rotate(-90deg)"></v-icon>
                </v-sheet>
              </v-col>
              <v-col cols="auto">
                <v-card-title class="subtitle-1 font-weight-bold pa-0">0 Transactions / 0,00 Total</v-card-title>
                <h4 class="subtitle-2 font-weight-regular text--secondary" align="end">Last 7 days</h4>
              </v-col>
            </v-row>
          </v-card>
        </v-hover>
        ...
        <v-hover v-slot:default="{ hover }">
          <v-card tile class="pa-5" outlined :elevation="hover ? 3 : 0">
            <v-row no-gutters justify="space-between" align="center">
              ...
              <v-col cols="auto">
                <v-card-title class="subtitle-1 font-weight-bold pa-0">0 Transactions / 0,00 Total</v-card-title>
                <h4 class="subtitle-2 font-weight-regular text--secondary" align="end">Last 24 hours</h4>
              </v-col>
            </v-row>
          </v-card>
        </v-hover>
