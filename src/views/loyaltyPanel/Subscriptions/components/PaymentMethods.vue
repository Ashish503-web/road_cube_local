    ...
    <v-tab-item>
        <v-container>
            ...
            >
                ...
                <v-col
                        class="border_top_payments_title  mt-3"
                        cols="12"
                >
                    ...
                    >
                        <h3>IBAN</h3>
                        <img src="https://www.roadcube.com//images/payments/iban.png" alt="" width="100">
                    </v-card>
            ...
            >
                <v-col cols="2" class="border_top_payment">
                    ...
                    >
                        ...
                        ></v-icon>
                        <img src="https://www.roadcube.com/images/payments/peiraeus.png" alt="" width="120"/>
...
<script>
    import {mdiMagnify, mdiOfficeBuildingOutline, mdiClose} from "@mdi/js";
