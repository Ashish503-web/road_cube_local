    ...
    <v-container fluid class="b-container">
        <v-sheet class="pa-3">
            <v-tabs v-model="tab" color="secondary">
                <v-tab class="text-capitalize">Monthly invoicing</v-tab>
                <v-tab class="text-capitalize">Redemption invoice</v-tab>
            </v-tabs>
...
<script>
import MonthlyInvoicing from "./tabs/MonthlyInvoicing";
import RedemptionInvoice from "./tabs/RedemptionInvoice";
export default {
    name: "BranchDebt",
    components: {
        MonthlyInvoicing,
